...
/usr/bin/maestro-led-ui.sh -stop
/usr/bin/maestro-led-ui.sh -chaser </dev/null &>/dev/null &
...
{
	/usr/bin/maestro-led-ui.sh -stop
        /usr/bin/maestro-led-ui.sh -blink </dev/null &>/dev/null &
        sleep infinity
}
...
finish()
{
	...
	/usr/bin/maestro-led-ui.sh -stop
        /usr/bin/maestro-led-ui.sh -solid </dev/null &>/dev/null &
	sleep infinity
}
